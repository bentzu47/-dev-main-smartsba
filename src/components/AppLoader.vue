<template>
    <div id="fswaitlayer">
      <div class="snippet">
        <div class="stage">
          <svg xmlns="http://www.w3.org/2000/svg" width="300" height="100" viewBox="0 0 24 24">
            <g transform="translate(0 24) scale(1 -1)">
              <circle cx="18" cy="12" r="0" fill="#1bc89b">
              ...
              <circle cx="12" cy="12" r="0" fill="#1ab5a7">
                <animate attributeName="r" begin=".33" calcMode="spline" dur="1.5s"
                  keySplines="0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8;0.2 0.2 0.4 0.8" repeatCount="indefinite" values="0;2;0;0" />
              </circle>
              <circle cx="6" cy="12" r="0" fill="#5dacff">
        ...
        <p id="fswaitlayer-text">Please Wait<span class="loader-dots"></span></p>
      </div>
    </div>
  </template>
  ...
  */
  #fswaitlayer {
    ...
    background: rgb(236 236 236 / 85%) !important;
    z-index: 10009;
  }
  ...
  #fswaitlayer .loader-text > .loader-dots {
    width:  18px;
  }
  
  #fswaitlayer .loader-text > .loader-dots::after {
    display: contents;
    content: " ";
